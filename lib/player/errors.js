...
const MEDIA_ERROR_CODES = {
  ...
  4: { label: 'SRC_NOT_SUPPORTED', kind: 'codec', message: 'This source format cannot be played in the browser.', retriable: false, action: 'rotate-source', hint: 'The manifest answered but the video behind it is missing or HEVC/4K (undecodable in browsers) — try another channel, or re-sync sources from the service panel.' },
};
