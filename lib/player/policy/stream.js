...
/**
 * Plain-file / manifest policy for Stremio + Mirchi direct sources.
 * No DRM, no header injection, nothing to recover except rotating to the
 * next fallback URL (which the engine owns).
 */
