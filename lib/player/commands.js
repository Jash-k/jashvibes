...
export const COMMANDS = {
  ...
  seekBack30: { label: 'Back 30 s', keys: ['shift+arrowleft'], gesture: null, button: true },
  seekForward30: { label: 'Forward 30 s', keys: ['shift+arrowright'], gesture: null, button: true },
  ...
  nudgeVolumeDown: { label: 'Volume down', keys: ['arrowdown'], gesture: 'swipe-right-down', button: true },
  ...
  speedUp: { label: 'Faster', keys: [']', '>'], gesture: 'long-press', button: true },
  speedDown: { label: 'Slower', keys: ['[', '<'], gesture: null, button: true },
  speedReset: { label: 'Normal speed', keys: ['\\'], gesture: null, button: true },
  toggleFullscreen: { label: 'Fullscreen', keys: ['f'], gesture: null, button: true },
  togglePip: { label: 'Picture in picture', keys: ['p', 'o'], gesture: null, button: true },
  cycleCaptions: { label: 'Subtitles on/off', keys: ['t', 'c', 's'], gesture: null, button: true },
  openSubtitles: { label: 'Subtitle options', keys: ['shift+c'], gesture: 'menu', button: true },
  ...
  cycleAudioTrack: { label: 'Audio track', keys: ['a'], gesture: 'menu', button: true },
  cycleQuality: { label: 'Quality', keys: ['q'], gesture: 'menu', button: true },
  qualityAuto: { label: 'Quality: auto', keys: ['shift+q'], gesture: null, menu: true },
  toggleAmbient: { label: 'Ambient dim', keys: ['y'], gesture: null, menu: true },
  ...
  lockControls: { label: 'Lock player', keys: ['shift+l'], gesture: 'menu', button: true },
  ...
  replaySegment: { label: 'Replay 10 s', keys: ['r'], gesture: null, button: true },
  loopSegment: { label: 'A–B loop', keys: ['shift+r'], gesture: null, menu: true },
  restart: { label: 'Restart from 0', keys: ['home'], gesture: 'menu', button: true },
