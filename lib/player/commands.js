...
export const COMMANDS = {
  ...
  speedUp: { label: 'Faster', keys: [']', '>'], gesture: 'long-press' },
  speedDown: { label: 'Slower', keys: ['[', '<'], gesture: null, desktopOnly: true },
  speedReset: { label: 'Normal speed', keys: ['\\'], gesture: null, desktopOnly: true },
  ...
  openSubtitles: { label: 'Subtitles on/off (was: options)', keys: ['shift+c'], gesture: null, desktopOnly: true },
  subtitleDelayUp: { label: 'Subtitle delay +250 ms', keys: ['shift+arrowup'], gesture: null, desktopOnly: true },
  subtitleDelayDown: { label: 'Subtitle delay −250 ms', keys: ['shift+arrowdown'], gesture: null, desktopOnly: true },
  cycleAudioTrack: { label: 'Audio track', keys: ['a'], gesture: null, desktopOnly: true },
  cycleQuality: { label: 'Quality', keys: ['q'], gesture: null, menu: true },
  ...
  toggleStats: { label: 'Stats overlay', keys: ['i'], gesture: null, desktopOnly: true },
  ...
  freezeFrame: { label: 'Freeze frame (hold the picture)', keys: ['shift+f'], gesture: null, desktopOnly: true },
  ...
  restart: { label: 'Restart from 0', keys: ['home'], gesture: null, desktopOnly: true },
  closeMenus: { label: 'Close menu', keys: ['escape'], gesture: 'tap-outside' },
  toggleBrowser: { label: 'Channel guide', keys: ['g'], gesture: null, button: true },
...
/**
 * Parity report — used by `tests/player-commands.test.js`.
 *
