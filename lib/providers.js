export const SCRAPER_PROVIDERS = [
  {
    id: 'screenscape',
    name: 'ScreenScape Embed',
    description: 'Direct screenscape.me TMDB embed player URL.',
  },
  {
    id: 'vidlink',
    name: 'VidLink',
  ...
  },
  {
    id: 'videasy',
    name: 'Videasy',
    description: 'TMDB embed provider: player.videasy.net/movie/{tmdbId} and /tv/{tmdbId}/{season}/{episode}.',
  },
  {
    id: 'vidzee',
    name: 'VidZee',
...
export function getProviderIdFromSource(source = {}) {
  ...
  if (text.includes('screenscape') || text.includes('screenscape.me')) return 'screenscape';

  return normalizeProviderId(source.provider || 'screenscape') || 'screenscape';
}
