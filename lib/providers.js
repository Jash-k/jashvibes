export const SCRAPER_PROVIDERS = [
  ...
  },
  {
    id: 'stremio',
    name: 'Stremio',
    description: 'Direct Telegram file streams from your Stremio addon; plays via the internal player with seek/resume.',
  },
  {
    id: 'vidlink',
    name: 'VidLink',
...
export function getProviderIdFromSource(source = {}) {
  ...
  if (text.includes('stremio')) return 'stremio';
