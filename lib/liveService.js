...
const SPORTS_CATALOG_SOURCE_IDS = new Set(['romaxa55-sports']);
...
export async function ensureLiveServiceSeeded() {
  ...
  // Purge sources whose upstream died (v10.2.1: the v10.2.0 sports packs
  // served 200-OK manifests over dead segments). Unmapped candidate rows go
  // with them; anything mapped or favorited is kept so curated work survives.
