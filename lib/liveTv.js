...
export const DEFAULT_SOURCES = [
  ...
  {
    // Verified live 2026-09-25 (probe: HTTP 200 manifest on 5/5 sampled
    // channels): hourly GitHub-Actions re-streams, plain HLS — no tokens, no
    // ClearKey, the browser plays them directly. 55 cricket channels in 4K
    // incl. Star Sports 1 Tamil. Known risk: everything rides one Cloudflare
    // worker — the Sony backup below and the health sweep cover for it.
    id: 'in-iptv-sports',
    label: 'Cricket 4K Pack',
    type: 'm3u',
    url: 'https://raw.githubusercontent.com/Babuperumana/IN_IptV/main/sports.m3u',
    trustTamil: false,
    priority: 5,
    autoPurge: true,
  },
  {
    // Same repo, Yupp FAST bundle: Willow Sports plus news/movie FAST
    // channels on amagi.tv CDNs (very reliable). All plain HLS.
    id: 'in-iptv-fast',
    label: 'Willow & FAST TV',
    type: 'm3u',
    url: 'https://raw.githubusercontent.com/Babuperumana/IN_IptV/main/yupptvfast.m3u',
    trustTamil: false,
    priority: 6,
    autoPurge: true,
  },
  {
    // iptv-org's maintained sports category (431 channels, daily rebuild) as
    // the always-on Sony Sports backup. titleFilter trims it to the
    // Indian-relevant set so the unmapped pool stays clean.
    id: 'iptv-org-sports',
    label: 'Sports Backup (iptv-org)',
    type: 'm3u',
    url: 'https://iptv-org.github.io/iptv/categories/sports.m3u',
    trustTamil: false,
    priority: 7,
    autoPurge: true,
    titleFilter: 'sony sports|sports ten|star sports|willow|fancode|sports 18|dd sports',
  },
];
