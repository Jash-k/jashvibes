...
const PLAYABLE_CHANNEL_STATES = new Set(['ready', 'proxy']);
 ...
 * `channels` is a live-TV catalog slice. Channels that need a key — any key —
 * are never ranked: the sports board has nothing to say about keys.
 */
